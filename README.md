...
2. 随后你会发现在`/target/site/jacoco`目录下有一个产生了一个名字为`index.html`的文件（至于为什么会产生，请学习maven并查看pom.xml配置），在浏览器打开这个文件，你会看到下图：![image-20191115210656311](/Users/zhouhang/Library/Application Support/typora-user-images/image-20191115210656311.png)
